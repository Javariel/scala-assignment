...
class AnagramsSuite {
  ...
  @Test def `extra dictionaryByOccurrences.get: eat (10pts)`: Unit =
    System.out.println(dictionaryByOccurrences.get(List(('a', 1), ('e', 1), ('t', 1))))
  ...
  @Test def `extra combinations: abccba (8pts)`: Unit = {
    ...
    assertEquals(abccbacomb.toSet, combinations(abccba).toSet)
  }

  @Test def `extra combinations: abba (8pts)`: Unit = {
    val abba = List(('a', 2), ('b', 2))
    System.out.println(combinations(abba))
  }
